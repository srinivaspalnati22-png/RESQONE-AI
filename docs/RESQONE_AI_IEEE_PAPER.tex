...
\section{System Architecture \& Operational Implementation}

The RESQONE-AI+ system was implemented as a production-ready edge-cloud application. Fig.~\ref{fig:screenshots} displays the primary operational interfaces of the deployed system across four core emergency modules.

\begin{figure*}[htbp]
\centering
\begin{minipage}{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figures/screenshot_crash_telemetry.png}
  \caption*{(a) Edge Kinematic 3D Crash Telemetry \& 4.85G Impact Detection}
\end{minipage}\hfill
\begin{minipage}{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figures/screenshot_snakebite_ai.png}
  \caption*{(b) Neural Vision Snakebite Triage \& 10-Vial AVS Dosage Titration}
\end{minipage}
\vspace{0.3cm}
\begin{minipage}{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figures/screenshot_blood_mesh.png}
  \caption*{(c) Deterministic ABO/Rh Compatibility \& Proximity Blood Mesh}
\end{minipage}\hfill
\begin{minipage}{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figures/screenshot_dashboard.png}
  \caption*{(d) Real-Time CAD Multi-Agency Mission Control \& Bed Telemetry}
\end{minipage}
\caption{Operational interfaces of the deployed RESQONE-AI+ ecosystem: (a) real-time 3-axis accelerometer and gyroscope sensor stream capturing vehicular rollover impact; (b) multimodal clinical envenomation assistant matching Russell's Viper (*D. russelii*) and routing to GGH Vijayawada; (c) ABO/Rh compatibility matrix locating nearest O- cryo-reserves; and (d) multi-agency Computer-Aided Dispatch mission control console.}
